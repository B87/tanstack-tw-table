...
/**
 * Helper factory for creating a DataTable i18n adapter from react-i18next
 *
 * @example
 * ```tsx
 ...
 * ```
 *
 * Expected translation file structure (locales/en/dataTable.json):
 * ```json
 * {
 *   "table": {
 ...
 *     "rowsSelected_zero": "No rows selected",
 ...
 * ```
 */
export function createReactI18nextAdapter(
